...
import { getClient, addClient } from '../services/clientService';
    ...
    return (
        <Layout style={{ minHeight: '200vh' }}>
            ...
            <Layout style={{ marginLeft: collapsed ? 80 : 200 }}>
                ...
                <Breadcrumb style={{ margin: '16px 0', padding: '0 30px' }}>
                    {selectedUser ? (
                        ...
                        <Breadcrumb.Item>Зарегистрируйтесь или войдите в аккаунт</Breadcrumb.Item>
                    )}
                </Breadcrumb>
            ...
            <Modal
                ...
                footer={null}
            >
                <RegistrationForm onSubmit={(client) => dispatch(addClient(client))} />
            </Modal>
        </Layout>
    );
};
